...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-805-erd-s-problem-805-b71d78a8-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-805"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-805-erd-s-problem-805-b71d78a8-v1",
      "problem_contract_sha256": "4319f72c210a7bd038a8324efa3f07ea6db9243a56f002c880cc2c391696810d",
      "problem_id": "problem:um-ep-805-erd-s-problem-805-b71d78a8",
      "route_id": "route:um-ep-805-erd-s-problem-805-b71d78a8-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-805-erd-s-problem-805-b71d78a8-source-fidelity-01",
      "graph_id": "graph:um-ep-805-erd-s-problem-805-b71d78a8-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-805-erd-s-problem-805-b71d78a8-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-805-erd-s-problem-805-b71d78a8-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For which functions $g(n)$ with $n>g(n)\\geq (\\log n)^2$ is there a graph on $n$ vertices in which every induced subgraph on $g(n)$ vertices contains a clique of size $\\geq \\log n$ and an independent set of size $\\geq \\log n$? In particular, is there such a graph for $g(n)=(\\log n)^3$?"
          },
          "statement_sha256": "8e28268d984843d23aac718b72a694653b661f3ed3c4ec8d7f84bda8600d7aa3"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-805-erd-s-problem-805-b71d78a8-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-805-erd-s-problem-805-b71d78a8-root",
      "route_id": "route:um-ep-805-erd-s-problem-805-b71d78a8-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-805-d639326599bb",
        "url": "https://www.unsolvedmath.com/problems/EP-805"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
